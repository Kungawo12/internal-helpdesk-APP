    ...
    <div className="min-h-screen bg-bg-dark pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-10 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white tracking-tight">Team Communication</h1>
        ...
        <div className="card p-10 bg-white/[0.02] border-white/5 whitespace-pre-wrap font-mono text-sm leading-relaxed text-slate-300">
          {comms ? (
            <div>
        ...
        <div className="mt-10 p-6 rounded-xl bg-slate-900/50 border border-white/5 text-xs text-subtle italic">
