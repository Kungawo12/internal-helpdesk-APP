      ...
      <div className="lg:col-span-3 space-y-8">
        ...
        <div className="flex gap-2 mb-6 border-b border-slate-200 dark:border-slate-700  pb-2 overflow-x-auto">
          {[
            ...
            >
              {tab.label}
              <span className={`text-xs px-1.5 py-0.5 rounded-full ${statusFilter === tab.value ? "bg-white dark:bg-slate-900/20 text-slate-900 dark:text-white" : "bg-slate-100 dark:bg-slate-800  text-slate-600 dark:text-slate-500 "}`}>
                {tab.count}
              </span>
            </button>
          ))}
